...
class QQConnect{
    ...
    public function login($app_id, $callback, $scope){
        ...
        /*$login_url = "https://graph.qq.com/oauth/show?which=ConfirmPage&display=pc&response_type=code&
        client_id=".$app_id."&redirect_uri=".urlencode($callback). "&state=" . $_SESSION['state']
